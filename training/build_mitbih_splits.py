...
RAW_DIR = BASE_DIR / "archive" / "mitbih_database"
...
def main():
    ...
    for s_name in ["train", "val", "test"]:
        ...
        # Also copy to training/quickstart-pytorch so those scripts locate them immediately
        alt_out = os.path.join(str(BASE_DIR / "training" / "quickstart-pytorch"), f"mitbih_{s_name}_ready.npz")
