...
# Data lives in the repository's data/ directory (training/quickstart-pytorch/
# pytorchexample/task.py -> repo root is parents[3]). Set the
# LIVEGUARD_DATA_DIR environment variable to override it; it takes
# precedence over the repo-relative default.
