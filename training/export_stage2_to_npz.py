...
if __name__ == "__main__":
    ...
    pth = os.path.join(_ROOT, "data", "stage2_multiclass_cnn.pth")
    if os.path.exists(pth):
        export_stage2_to_numpy(pth, os.path.join(_ROOT, "data", "stage2_weights.npz"))
        export_stage2_to_numpy(pth, os.path.join(_ROOT, "training", "quickstart-pytorch", "stage2_weights.npz"))
    else:
