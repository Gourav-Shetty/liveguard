...
def create_laptop_guide_docx():
    ...
    doc.add_paragraph(
        ...
        f"2. Open file: {ROOT_DIR / 'backend' / 'arduino_bridge' / 'liveguard_sensor_bridge.ino'}\n"
    ...
    doc.add_paragraph(
        f"1. Open PowerShell or Command Prompt in {ROOT_DIR}\n"
    ...
    output_path = str(BASE_DIR / "LiveGuard_Laptop_Arduino_Quickstart.docx")
